...
class _CustomSwitchState extends State<CustomSwitch>
  ...
  void initState() {
    ...
    _trackColor = ColorTween(
      begin:
          widget.value ? widget.activeColor : widget.activeColor.withAlpha(100),
      end:
          widget.value ? widget.activeColor.withAlpha(100) : widget.activeColor,
              ...
              child: Align(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: widget.value ? null : Colors.black12,
